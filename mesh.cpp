...
Mesh::Mesh(const std::vector<GLuint> &indices, const std::vector<Texture> &textures) {
...
//	VBO myVBO(&vertices[0], vertices.size() * sizeof(Vertex));
...
//    myVBO.Bind();
//    myEBO.Bind();
//    myVAO.LinkAttrib(myVBO, 0, 3, GL_FLOAT, sizeof(Vertex), (void *)0);
//    myVAO.LinkAttrib(myVBO, 1, 3, GL_FLOAT, sizeof(Vertex), (void *)offsetof(Vertex, Normal));
//    myVAO.LinkAttrib(myVBO, 2, 2, GL_FLOAT, sizeof(Vertex), (void *)offsetof(Vertex, TexCoords));
//    myVAO.Unbind();
//    myVBO.Unbind();
//    myEBO.Unbind();
}
